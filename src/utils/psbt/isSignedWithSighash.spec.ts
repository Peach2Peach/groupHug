...
import { missingSignaturePsbt, psbt1, wrongSighashPsbt } from '../../../test/data/psbtData'
...
describe('isSignedWithSighash', () => {
  ...
  it('returns false for PSBT with invalid signatures', () => {
    expect(isSignedWithSighash(wrongSighashPsbt, 'SINGLE_ANYONECANPAY')).to.be.false
    expect(isSignedWithSighash(missingSignaturePsbt, 'SINGLE_ANYONECANPAY')).to.be.false
  })
})
